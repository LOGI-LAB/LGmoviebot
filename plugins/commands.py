...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ ʟɢ ʙᴏᴛ ꜱᴏᴄɪᴇᴛʏ ⭕️', url='https://t.me/lgbots')
            ],
            [
        ...
        await client.send_sticker(chat_id=message.chat.id, sticker='CAACAgUAAxkBAAN7Yl7droisEbkRIgdcPJ5qWN7a-q8AAj4EAALQ4FBXoaSYICef4OQkBA', reply_markup=reply_markup, reply_to_message_id=message.message_id)
